...
#enlaces ----
enlaces <- paste0("https://www.eldinamo.cl/category/pais/page/", 1:3); hist = ""
...
readr::write_rds(resultados_eldinamo, 
                 # glue("resultados/eldinamo/eldinamo_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("eldinamo", hist)
                 )
