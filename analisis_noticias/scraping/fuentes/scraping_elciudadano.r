...
# guardar ----
# dir.create("resultados/elciudadano/", showWarnings = F)
# resultados_elciudadano

readr::write_rds(resultados_elciudadano,
                 # glue("resultados/elciudadano/elciudadano_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("elciudadano", hist)
)
