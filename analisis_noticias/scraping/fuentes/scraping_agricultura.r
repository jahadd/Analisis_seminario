...
# dir.create("resultados/agricultura/", showWarnings = F)

readr::write_rds(resultados_agricultura,
                 # glue("resultados/agricultura/agricultura_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("agricultura", hist),
                 compress = "gz")
