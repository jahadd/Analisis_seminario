...
# guardar ----
# dir.create("resultados/meganoticias/", showWarnings = F)

readr::write_rds(resultados_meganoticias, 
                 # glue("resultados/meganoticias/meganoticias_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("meganoticias", hist)
                 )
