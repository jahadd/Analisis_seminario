...
# guardar ----
# resultados_quintopoder
# dir.create("resultados/quintopoder/", showWarnings = F)

readr::write_rds(resultados_quintopoder,
                 # glue("resultados/quintopoder/quintopoder_cron_{rng()}_{lubridate::today()}{hist}.rds"), 
                 ruta_resultado("quintopoder", hist),
                 compress = "gz")
