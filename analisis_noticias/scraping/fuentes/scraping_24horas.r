...
#enlaces ----
enlaces <- paste0("https://www.24horas.cl/actualidad/nacional/p/", 1:5); hist = ""
...
# guardar ----
# dir.create("scraping/datos/24horas/", showWarnings = F)

readr::write_rds(resultados_24horas, 
                 # glue("resultados/24horas/24horas_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("24horas", hist)
                 )
