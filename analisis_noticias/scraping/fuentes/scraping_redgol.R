...
categorias <- c("https://redgol.cl/tema/actualidad-nacional",
                paste0("https://redgol.cl/tema/actualidad-nacional?page=", 2:3),
                "https://redgol.cl/tema/politica",
                paste0("https://redgol.cl/tema/politica?page=", 2:3),
                "https://redgol.cl/tema/dato-util",
                paste0("https://redgol.cl/tema/dato-util?page=", 2:3),
...
# guardar ----
# resultados_redgol
# dir.create("resultados/redgol/", showWarnings = F)

readr::write_rds(resultados_redgol,
                 # glue("resultados/redgol/redgol_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("redgol", hist)
                 )
