...
# guardar ----
# resultados_eldesconcierto
# dir.create("resultados/eldesconcierto/", showWarnings = F)

readr::write_rds(resultados_eldesconcierto, 
                 # glue("resultados/eldesconcierto/eldesconcierto_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("eldesconcierto", hist)
                 )
