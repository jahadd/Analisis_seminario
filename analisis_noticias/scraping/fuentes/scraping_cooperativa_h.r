...
# dir.create("resultados/cooperativa/", showWarnings = F)

readr::write_rds(resultados_cooperativa, 
                 # glue("resultados/cooperativa/cooperativa_cron_{rng()}_{lubridate::today()}{hist}.rds"),
                 ruta_resultado("cooperativa", hist)
                 )
