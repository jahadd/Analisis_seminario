...
# guardar ----
# dir.create("resultados/elmostrador/", showWarnings = F)

readr::write_rds(resultados_elmostrador,
                 # glue("resultados/elmostrador/elmostrador_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("elmostrador", hist)
)
