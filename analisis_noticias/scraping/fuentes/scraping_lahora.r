...
# guardar ----
#resultados_lahora
# dir.create("resultados/lahora/", showWarnings = F)

readr::write_rds(resultados_lahora,
                 # glue("resultados/lahora/lahora_cron_{rng()}_{lubridate::today()}.rds")
                 ruta_resultado("lahora")
                 )
