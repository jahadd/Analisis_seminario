...
enlaces <- c("https://www.chilevision.cl/noticias",
  ...
  "https://www.chilevision.cl/noticias/economia"); hist = ""
...
# dir.create("resultados/chvnoticias/", showWarnings = F)

readr::write_rds(resultados_chvnoticias, 
                 # glue("resultados/chvnoticias/chvnoticias_cron_{rng()}_{today()}.rds")
                 ruta_resultado("chvnoticias", hist)
                 )
