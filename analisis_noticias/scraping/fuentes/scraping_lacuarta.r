...
enlaces <- paste0("https://www.lacuarta.com/cronica/", 1:3); hist = ""
...
readr::write_rds(resultados_noticias, 
                 # glue("resultados/lacuarta/lacuarta_cron_{rng()}_{lubridate::today()}{hist}.rds")
                 ruta_resultado("lacuarta", hist)
                 )
