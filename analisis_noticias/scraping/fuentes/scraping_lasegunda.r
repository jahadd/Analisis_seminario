...
# guardar ----
# resultados_lasegunda
# resultados_lasegunda |> pull(cuerpo)

# dir.create("resultados/lasegunda/", showWarnings = F)

readr::write_rds(resultados_lasegunda, 
                 # glue("resultados/lasegunda/lasegunda_cron_{rng()}_{lubridate::today()}.rds")
                 ruta_resultado("lasegunda", hist)
                 )
