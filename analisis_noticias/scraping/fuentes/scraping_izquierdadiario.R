...
# guardar ----
# resultados_izquierdadiario
# dir.create("resultados/izquierdadiario/", showWarnings = F)

readr::write_rds(resultados_izquierdadiario, 
                 ruta_resultado("izquierdadiario", hist)
                 )
